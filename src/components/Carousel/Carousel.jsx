  ...
  return (
    works && (
      <div className="relative p-0">
        ...
        <button
          className="prev-btn absolute top-1/2 left-5 transform -translate-y-1/2 text-3xl rounded-full p-2 bg-black/40 text-white font-black cursor-pointer"
        ...
        <button
          className="next-btn absolute top-1/2 right-5 transform -translate-y-1/2 text-3xl rounded-full p-2 bg-black/40 text-white cursor-pointer"
